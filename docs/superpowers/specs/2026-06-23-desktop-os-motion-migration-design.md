...
- C 档产物落 `docs/superpowers/specs/2026-06-23-desktop-os-motion-migration-design.md`(本文件)+ `docs/superpowers/plans/2026-06-23-desktop-os-motion-migration.md`,按 `AGENTS.md` 的临时工作产物规则。
