...
- [AI 工作台后续路线图](./superpowers/plans/2026-07-18-ai-workbench-next-roadmap.md)：P12 运行可靠性、P13 资源中心、P14 生产治理的范围与进入条件。
- [P12 运行可靠性与 AI 协作闭环](./superpowers/plans/2026-07-18-workflow-reliability-p12-spec.md)：下一阶段的规格、接口边界、验收标准与实施顺序。
