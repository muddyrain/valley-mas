...
- [AI 动态表情工作台](./specs/2026-08-08-ai-motion-stickers-design.md)：参考图驱动的生图组帧 GIF、可选视频增强、持久后台任务和多调用方共享工具边界。
...
- [创作者智能体工具卡](./specs/2026-08-08-creator-agent-tool-cards-design.md)：结构化澄清、内部转换工具、图片/文件卡片、临时私有产物和写操作确认。
