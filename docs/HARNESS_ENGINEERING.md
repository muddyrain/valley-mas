...
| Skill 路由 | `.codex/skills/INDEX.md` | 按任务类型启用对应协作能力 |
| 项目 skills | `.codex/skills/*/SKILL.md` | 约束编码、文档同步、编码检查、提交信息等流程 |
...
- 涉及中文、Markdown、skill 或配置示例时使用 encoding 检查
...
| 中文/Markdown/skill | `python .codex/skills/encoding-guard/scripts/check_mojibake.py <相关文件>` |
