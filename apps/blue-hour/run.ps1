...
switch ($Mode) {
    ...
    'test' {
        ...
        Invoke-Engine @('--headless', '--script', 'tests/survivor_animation_batch.gd')
    ...
    'capture' {
        ...
        Invoke-Engine @('--position', '-3000,-3000', '--resolution', '1600x900', '--audio-driver', 'Dummy', '--script', 'tests/survivor_animation_batch.gd', '--', 'capture')
    ...
    'build' {
        ...
        $buildInfo = [ordered]@{
            ...
            combatAnimationChecks = @('survivor-animation-batch', 'combat-animation-mission-headless', 'combat-animation-mission-native', 'locomotion-polish', 'locomotion-mission', 'survivor-locomotion', 'embedded-pack-survivor-batch-headless', 'embedded-pack-survivor-batch-native')
