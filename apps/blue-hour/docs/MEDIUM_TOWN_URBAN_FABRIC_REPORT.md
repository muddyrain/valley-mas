...
The original inspection treated every BLD_009 through BLD_022 wrapper as having a +Z facade despite -Z FrontMarker anchors. The 2026-09-19 [entrance/frontage audit](TOWN_ENTRANCE_FRONTAGE_AUDIT.md) corrected that claim: BLD_010 already faces -Z in its wrapper. MAIN_STREET instances rotate ModelRoot by 180 degrees only for BLD_009 and BLD_011 through BLD_022; BLD_010 retains its authored correction. Shared Runtime Scenes, definitions, anchors, collisions and GLB files remain unchanged, so the other profiles are unaffected. Geometric tests instantiate this exact renderer path and remeasure the transformed meshes. The original contact sheets remain under `test-output/random-map/contact-9.jpg` and `contact-16.jpg`; the corrected audit covers all 22 assets.
