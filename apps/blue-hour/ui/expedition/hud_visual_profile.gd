...
const PARTY_SCALE: float = .95
const OBJECTIVE_SCALE: float = .85
const ACTION_SCALE: float = .90
const RETURN_SCALE: float = .85
...
const COMPACT_SIZE: Vector2 = Vector2(224, 64)
const SEARCH_SIZE: Vector2 = Vector2(282, 176)
