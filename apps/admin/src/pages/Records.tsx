...
const downloadData: DownloadRecord[] = [
  {
    ...
    resource: '可爱卡通头像',
    creator: '设计师小王',
    downloadedAt: '2026-02-28 10:30:00',
  },
  {
    id: '2',
    user: '用户B',
    resource: '风景壁纸',
    creator: '摄影师老李',
    downloadedAt: '2026-02-28 11:45:00',
  },
];
...
const uploadData: UploadRecord[] = [
  {
    ...
    resource: '可爱卡通头像',
    type: 'avatar',
    uploadedAt: '2026-02-20 10:00:00',
  },
  {
    id: '2',
    creator: '摄影师老李',
    resource: '风景壁纸',
    type: 'wallpaper',
    uploadedAt: '2026-02-21 14:30:00',
  },
];
          ...
          items={[
            {
              key: 'download',
              label: '下载记录',
              children: <Table columns={downloadColumns} dataSource={downloadData} rowKey="id" />,
            },
            {
              key: 'upload',
              label: '上传记录',
              children: <Table columns={uploadColumns} dataSource={uploadData} rowKey="id" />,
            },
          ]}
        />
      </Card>
