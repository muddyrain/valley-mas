...
import { HISTORICAL_EMPERORS_SCENARIO } from './historical-emperors';
...
export { CUSTOM_SCENARIO, HISTORICAL_EMPERORS_SCENARIO, RANDOM_SCENARIO, THREE_KINGDOMS_SCENARIO };
