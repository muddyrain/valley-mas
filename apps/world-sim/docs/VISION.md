...
- Village loyalty, unrest, sustained rebellion preparation, and first split founding inside kingdoms, so distance from capital, overextension, food pressure, war pressure, and strong frontier towns become readable before a rebel village forms a new kingdom and enters conflict with the parent realm.
