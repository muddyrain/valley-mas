        ...
        <div className="relative mb-16 overflow-hidden rounded-4xl border border-violet-200/80 bg-white shadow-[0_20px_70px_rgba(95,55,156,0.18)]">
          ...
          <div className="relative z-10 grid items-center gap-10 px-6 py-10 md:px-10 md:py-12 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            <div className="relative hidden min-h-105 lg:block">
              <div className="absolute right-8 top-10 h-75 w-75 rounded-full bg-[radial-gradient(circle,#fdba74_0%,rgba(253,186,116,0.16)_42%,transparent_72%)] blur-2xl" />
              <div className="absolute right-16 top-16 h-90 w-65 rounded-[140px] border border-violet-200/70 bg-linear-to-b from-white/70 to-white/20 backdrop-blur-sm" />
              <div className="absolute right-28 top-20 h-82.5 w-55 rounded-[120px] bg-linear-to-b from-violet-50/95 via-violet-200/40 to-transparent" />
              <div className="absolute right-12 top-24 h-77.5 w-57.5 [clip-path:polygon(20%_0%,82%_8%,98%_30%,88%_75%,62%_100%,20%_95%,6%_70%,8%_28%)] bg-linear-to-b from-violet-900/85 via-violet-700/75 to-transparent opacity-95" />
        ...
        <section className="mt-16">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
            {loadingBlogs ? (
              ...
              <div className="col-span-full py-12 text-center text-gray-400">暂无博客内容</div>
            ) : (
