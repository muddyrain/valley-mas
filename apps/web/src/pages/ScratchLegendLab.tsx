      ...
      <section className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl items-center px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid w-full gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:gap-8">
          ...
          <div className="rounded-[28px] border border-border bg-card/90 p-5 shadow-[0_24px_56px_hsl(var(--primary) / 0.12)]">
            <div className="flex h-full min-h-80 flex-col justify-between gap-6 rounded-[22px] border border-dashed border-border bg-[linear-gradient(180deg,hsl(var(--card)/0.92),hsl(var(--card)/0.96))] p-5">
              <div className="space-y-3">
