    ...
    >
      ...
      <div className="mt-3 px-1">
        ...
        <div className="mt-2 flex items-center justify-between text-sm text-muted-foreground">
          <div className="inline-flex min-w-0 items-center gap-1.5 rounded-full bg-muted/80 px-2.5 py-1">
            <User className="h-3.5 w-3.5 shrink-0" />
            <span className="truncate">{post.author?.nickname || '创作者'}</span>
          </div>
          <div className="inline-flex items-center gap-1 rounded-full bg-destructive/10 px-2.5 py-1 text-destructive">
