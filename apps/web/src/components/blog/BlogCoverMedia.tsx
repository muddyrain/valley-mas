    ...
    >
      {src ? (
        <>
          ...
          />
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_28%,hsl(var(--background)/0.32),hsl(var(--background)/0.06)_48%,transparent_78%)]" />
          <img
            src={src}
            alt={alt}
            className={cn(
