        ...
        <section className="account-window__panel account-window__mail" aria-label="邮箱绑定">
          ...
          <div className="account-window__mail-grid">
            ...
            <button
              type="button"
              className="dock-app-window__button"
              disabled={mailLoading || !qqEmail.trim() || !qqAuthorizationCode.trim()}
            ...
            {mailAccounts.map((account) => (
              <div className="account-window__mail-account" key={account.id}>
                <span>
                  ...
                  <small>
                    {getMailProviderLabel(account.provider)} · {getMailStatusLabel(account.status)}
                  </small>
                </span>
                <button
                  type="button"
                  onClick={() => void handleDeleteMailAccount(account.id)}
                  disabled={mailLoading}
                >
                  解绑
                </button>
