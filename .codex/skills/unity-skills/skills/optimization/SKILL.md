...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `maxTextureSize` | int | No | 2048 | Canonical signature parameter |
| `enableCrunch` | bool | No | true | Canonical signature parameter |
| `compressionQuality` | int | No | 50 | Canonical signature parameter |
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `compressionLevel` | string | No | "Medium" | Canonical signature parameter |
| `filter` | string | No | "" | Canonical signature parameter |
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `polyThreshold` | int | No | 10000 | Canonical signature parameter |
| `materialThreshold` | int | No | 5 | Canonical signature parameter |
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `thresholdKB` | int | No | 1024 | Canonical signature parameter |
| `assetType` | string | No | "" | Canonical signature parameter |
...
| `flags` | string | No | "Everything" | Canonical signature parameter |
| `includeChildren` | bool | No | false | Canonical signature parameter |
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `compressionFormat` | string | No | "Vorbis" | Canonical signature parameter |
| `loadType` | string | No | "CompressedInMemory" | Canonical signature parameter |
| `quality` | float | No | 0.5f | Canonical signature parameter |
| `filter` | string | No | "" | Canonical signature parameter |
...
| `instanceId` | int | No | 0 | Canonical signature parameter |
| `path` | string | No | null | Canonical signature parameter |
| `lodDistances` | string | No | "0.6,0.3,0.1" | Canonical signature parameter |
