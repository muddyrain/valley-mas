...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `assetType` | string | No | "Texture2D" | Canonical signature parameter |
| `searchPath` | string | No | "Assets" | Canonical signature parameter |
| `limit` | int | No | 50 | Canonical signature parameter |

### cleaner_find_missing_references
Find components with missing script or asset references

| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `includeInactive` | bool | No | true | Canonical signature parameter |

### cleaner_delete_assets
Delete specified assets. Step 1: Call without confirmToken to preview. Step 2: Call with confirmToken to execute.

| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `paths` | string[] | No | null | Canonical signature parameter |
| `confirmToken` | string | No | null | Canonical signature parameter |
...
|-----------|------|----------|---------|-------------|
| `searchPath` | string | No | "Assets" | Canonical signature parameter |
| `limit` | int | No | 20 | Canonical signature parameter |
| `minSizeBytes` | long | No | 0 | Canonical signature parameter |
...
|-----------|------|----------|---------|-------------|
| `assetPath` | string | Yes | - | Canonical signature parameter |
| `recursive` | bool | No | true | Canonical signature parameter |
