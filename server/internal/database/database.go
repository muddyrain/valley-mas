...
func autoMigrateModelsByName() map[string]any {
	return map[string]any{
		...
		"external_oauth_state":                 &model.ExternalOAuthState{},
		"external_connection_audit":            &model.ExternalConnectionAudit{},
		...
		"ai_motion_sticker_generation":         &model.AIMotionStickerGeneration{},
		"ai_image_generation":                  &model.AIImageGeneration{},
		"ai_canvas_document":                   &model.AICanvasDocument{},
		...
		"ai_app_task":                          &model.AIAppTask{},
		"ai_app_tool_approval":                 &model.AIAppToolApproval{},
		"ai_app_conversation_attachment":       &model.AIAppConversationAttachment{},
		"ai_app_artifact":                      &model.AIAppArtifact{},
		...
		"ai_skill":                             &model.AISkill{},
		"ai_skill_file":                        &model.AISkillFile{},
...
func autoMigrateModelAliases() map[string]string {
	return map[string]string{
		...
		"external_oauth_states":         "external_oauth_state",
		"external_connection_audits":    "external_connection_audit",
		"ai_usage":                      "ai_usage_log",
		"ai_usage_logs":                 "ai_usage_log",
		"ai_models":                     "ai_model",
		"ai_motion_sticker_generations": "ai_motion_sticker_generation",
		"mind_arena_sessions":           "mind_arena_debate_session",
		"mind_arena_messages":           "mind_arena_debate_message",
		"mind_arena_scores":             "mind_arena_debate_score",
		"ai_apps":                       "ai_app",
