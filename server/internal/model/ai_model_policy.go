...
type AIModel struct {
	...
	// Zero is reserved for non-embedding models. Embedding models must declare
	// the exact length returned for every vector.
	EmbeddingDimension int            `gorm:"not null;default:0" json:"embeddingDimension,omitempty"`
