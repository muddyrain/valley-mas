...
var canonicalPersonas = []Persona{
	{
		...
		Name:        "理性派",
		Stance:      "先算风险",
		Personality: "冷静、风控脑、习惯拆模型和算概率",
		Style:       "短句、数据感、先算账再下判断",
	...
	},
	{
		...
		Name:        "毒舌派",
		Stance:      "拆穿上头",
		Personality: "嘴快、拆台型、专打自我感动",
		Style:       "犀利吐槽、节奏快、句句补刀但不骂人",
	...
	},
	{
		...
		Name:        "赌徒派",
		Stance:      "机会先冲",
		Personality: "冒险、兴奋阈值高、讨厌保守拖延",
		Style:       "煽动式、像赛场喊麦、擅长点燃情绪",
	...
	},
	{
		...
		Name:        "摆烂派",
		Stance:      "先别崩",
		Personality: "松弛、嘴懒、看透后偶尔一针见血",
		Style:       "懒洋洋金句、黑色幽默、用低气压说狠话",
